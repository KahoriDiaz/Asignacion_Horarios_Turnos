...
-- ==========================================
-- TABLA: distribucion_anual_salas
-- ==========================================
...
INSERT INTO empleado (DNI_Personal, ApellidosNombres, Celular, FechaNacimiento, Estado, Encargado, Nro_Piso, ID_Subespecialidad, ID_Condicion) VALUES
('87654321', 'Carmen Vilca', '999888777', '1980-04-10', 'Activo', 1, 4, 2, 1),    -- Encargada
('12345678', 'Luis Ramos', '987654321', '1992-05-12', 'Activo', 0, 4, 1, 2),
('11223344', 'Ana Torres', '988877665', '1988-08-19', 'Activo', 0, 4, 3, 1),
('22113344', 'Pedro Díaz', '911222333', '1990-11-25', 'Activo', 0, 2, 2, 3);

INSERT INTO personal_por_piso (DNI_Personal, Nro_Piso) VALUES
('87654321', 4),
('12345678', 4),
('11223344', 4),
('22113344', 2);

INSERT INTO personal_enfermeria (Nro_Piso, DNI_Encargado) VALUES
(4, '87654321');

INSERT INTO distribucion_anual_salas (NumeroSala, Anio_Distribucion, MinimosXTurno, Nro_Piso) VALUES
(101, 2025, 2, 4),
(102, 2025, 2, 4),
(201, 2025, 2, 2);

INSERT INTO personal_asignado_sala (Anio_Distribucion, NumeroSala, DNI_Personal, Rol) VALUES
(2025, 101, '87654321', 'Encargada'),
(2025, 101, '12345678', 'Enfermero'),
(2025, 102, '11223344', 'Enfermera'),
(2025, 201, '22113344', 'Supletorio');


-- Aquí puedes agregar más inserts de ejemplo para la programación mensual y turnos según tu lógica.
